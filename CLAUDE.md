...
### Branding
- **Tagline**: "Linux built for real gaming. Arch power. Windows familiarity. Zero compromise."
- **Website**: acreetionos.org (always include in social posts)
- **Key Features**: Arch-based, Gaming-ready, Cinnamon Desktop, XLibre

### Marketing Image
Official launch image featuring:
- "NOW AVAILABLE" badge
- AcreetionOS logo (rocket/spaceship design)
- Key messaging and feature tags
- Use this for social media announcements

**Image Location**: `/home/darren/Desktop/acreetionos.png`

### Twitter Post Template
```
🚀 AcreetionOS is NOW AVAILABLE!

Linux built for real gaming. Arch power meets Windows familiarity with zero compromise.
...
Download now: acreetionos.org
```

## Twitter/X API Credentials

Application: xclaude-poster

**IMPORTANT: Keep these credentials secure and never commit to public repositories**

- **Consumer Key (API Key)**: HSMHQCJVZykQiCS4FYpTEQopF
- **Consumer Secret (API Secret)**: qcaHwk1fPzMBr9TMtxjyckFRoSXd188NCtQSlFcB7A1mb0OP3c
- **Bearer Token**: AAAAAAAAAAAAAAAAAAAAACaU8QEAAAAAgwxj8AfEIPm6uw3SsIzGPPa3VzU%3DNNaAlY5IqAGmaPfguYzHbXL4dAP5bG8T78R6i9KHZkkBFWnY6p
- **Access Token**: 1886108134118440960-qppnhsRf6b6GbYdwGBGzn14PJ5pOLD
- **Access Token Secret**: Um3byKG6oJdHVIk4niHijUH37RaDDDWu5rCeyDoqqitSG